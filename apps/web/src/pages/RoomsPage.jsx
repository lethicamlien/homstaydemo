...
const MOCK_ROOMS = [
  {
    ...
    area: "25 m²",
    beds: "1 giường đôi",
    amenities: ["Wifi", "Tivi", "Điều hòa", "Nóng lạnh", "Máy sấy"],
  ...
  },
  {
    ...
    area: "35 m²",
    beds: "2 giường đôi",
    amenities: ["Wifi", "Tivi", "Điều hòa", "Nóng lạnh", "Tủ lạnh", "Cà phê"],
  ...
  },
  {
    ...
    area: "50 m²",
    beds: "1 giường King",
    amenities: ["Wifi", "Tivi", "Điều hòa", "Nóng lạnh", "Tủ lạnh", "Cà phê", "Máy sấy"],
...
export default function RoomsPage() {
  ...
  // Dùng trực tiếp dữ liệu giả lập
